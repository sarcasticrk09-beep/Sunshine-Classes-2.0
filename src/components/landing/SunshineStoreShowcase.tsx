...
export const SunshineStoreShowcase: React.FC<SunshineStoreShowcaseProps> = ({ 
  ...
  return (
    <section id="sunshine-store-preview" className="py-12 sm:py-16 bg-white dark:bg-slate-900 border-b border-slate-200/60 dark:border-slate-800/60">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          ...
          <h2 className="font-display text-2xl sm:text-4xl font-black text-slate-900 dark:text-white">
            🛒 Sunshine Store
          </h2>
          <p className="text-amber-600 dark:text-amber-400 font-bold text-sm sm:text-base font-display">
            ...
            {categories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className="p-3.5 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/80 hover:border-amber-400 hover:bg-amber-50/50 dark:hover:bg-amber-950/30 text-center transition-all group cursor-pointer flex flex-col items-center justify-center space-y-2 shadow-xs"
                >
                  ...
                  <div>
                    <span className="block text-xs font-bold text-slate-900 dark:text-white line-clamp-1">
                      {cat.name}
                    </span>
