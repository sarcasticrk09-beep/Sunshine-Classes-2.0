...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigateSection }) => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-amber-500/10 via-slate-50 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 py-6 sm:py-10 lg:py-16 border-b border-slate-200/60 dark:border-slate-800/60">
      
      {/* Background Subtle Accent Gradients */}
      <div className="absolute top-0 right-0 -mr-20 -mt-20 h-72 w-72 sm:h-96 sm:w-96 rounded-full bg-amber-400/15 blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-0 -ml-20 -mb-20 h-72 w-72 sm:h-96 sm:w-96 rounded-full bg-blue-600/10 blur-3xl pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-left">
            ...
            {/* Small Trust Badge */}
            <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-3 py-1 text-[11px] sm:text-xs font-black text-amber-700 dark:text-amber-400 shadow-xs">
            ...
            {/* Main Headline */}
            <h1 className="font-display text-2xl xs:text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 dark:text-white leading-[1.18] tracking-tight">
            ...
            <p className="text-xs sm:text-base text-slate-600 dark:text-slate-300 leading-relaxed font-medium max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400 font-semibold pt-0.5">
          ...
          {/* Right Column - Academic Advantage Badge Box */}
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="w-full max-w-md rounded-2xl border border-slate-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm p-4 sm:p-6 shadow-xl relative overflow-hidden">
              ...
              <div className="space-y-3.5 sm:space-y-4">
                <div className="flex items-center justify-between pb-2.5 sm:pb-3 border-b border-slate-100 dark:border-slate-800">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 sm:h-9 sm:w-9 rounded-xl bg-amber-500/10 text-amber-600 dark:text-amber-400 flex items-center justify-center font-black shrink-0">
                      <GraduationCap size={18} />
                    </div>
                    <div>
                      <h3 className="font-display font-black text-xs sm:text-sm text-slate-900 dark:text-white">Sunshine Advantage</h3>
                ...
                <div className="grid grid-cols-2 gap-2 sm:gap-3">
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-800/60 p-2.5 sm:p-3 border border-slate-100 dark:border-slate-800">
                    <span className="text-xl sm:text-2xl font-black text-amber-500 font-display">100%</span>
                    <p className="text-[10px] sm:text-[11px] font-bold text-slate-700 dark:text-slate-300 mt-0.5">Board Success</p>
                    <p className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400">Class 10 CBSE Results</p>
                  </div>
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-800/60 p-2.5 sm:p-3 border border-slate-100 dark:border-slate-800">
                    <span className="text-xl sm:text-2xl font-black text-blue-500 font-display">25</span>
                    <p className="text-[10px] sm:text-[11px] font-bold text-slate-700 dark:text-slate-300 mt-0.5">Max Batch Size</p>
                    <p className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400">Personalized Attention</p>
                  </div>
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-800/60 p-2.5 sm:p-3 border border-slate-100 dark:border-slate-800">
                    <span className="text-xl sm:text-2xl font-black text-emerald-500 font-display">Free</span>
                    <p className="text-[10px] sm:text-[11px] font-bold text-slate-700 dark:text-slate-300 mt-0.5">NCERT Notes</p>
                    <p className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400">Chapterwise Worksheets</p>
                  </div>
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-800/60 p-2.5 sm:p-3 border border-slate-100 dark:border-slate-800">
                    <span className="text-xl sm:text-2xl font-black text-purple-500 font-display">Store</span>
                    <p className="text-[10px] sm:text-[11px] font-bold text-slate-700 dark:text-slate-300 mt-0.5">Book Depot</p>
                    <p className="text-[9px] sm:text-[10px] text-slate-500 dark:text-slate-400">On-Campus Essentials</p>
                  </div>
                </div>

                <div className="pt-1.5 text-center text-[10px] sm:text-[11px] text-slate-500 dark:text-slate-400 italic bg-amber-500/5 dark:bg-amber-500/10 rounded-xl p-2 sm:p-2.5 border border-amber-500/10">
